...
export interface VersionFields { pos0: ToField<"u16"> }
...
export class Version implements StructClass { __StructClass = true as const;
 ...
 static fromFields( fields: Record<string, any> ): Version { return Version.reified( ).new( { pos0: decodeFromFields("u16", fields.pos0) } ) }
 ...
 static fromJSONField( field: any ): Version { return Version.reified( ).new( { pos0: decodeFromJSONField("u16", field.pos0) } ) }
