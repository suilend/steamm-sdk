...
export class VotingPowerInfo implements StructClass { __StructClass = true as const;
 ...
 static phantom( ): PhantomReified<ToTypeStr<VotingPowerInfo>> { return phantom(VotingPowerInfo.reified( )); } static get p() { return VotingPowerInfo.phantom() }

 static get bcs() { return bcs.struct("VotingPowerInfo", {

 validator_index: bcs.u64(), voting_power: bcs.u64()

}) };

 static fromFields( fields: Record<string, any> ): VotingPowerInfo { return VotingPowerInfo.reified( ).new( { validatorIndex: decodeFromFields("u64", fields.validator_index), votingPower: decodeFromFields("u64", fields.voting_power) } ) }
 ...
 return VotingPowerInfo.reified( ).new( { validatorIndex: decodeFromFieldsWithTypes("u64", item.fields.validator_index), votingPower: decodeFromFieldsWithTypes("u64", item.fields.voting_power) } ) }

 static fromBcs( data: Uint8Array ): VotingPowerInfo { return VotingPowerInfo.fromFields( VotingPowerInfo.bcs.parse(data) ) }
 ...
 static fromJSONField( field: any ): VotingPowerInfo { return VotingPowerInfo.reified( ).new( { validatorIndex: decodeFromJSONField("u64", field.validatorIndex), votingPower: decodeFromJSONField("u64", field.votingPower) } ) }

 static fromJSON( json: Record<string, any> ): VotingPowerInfo { if (json.$typeName !== VotingPowerInfo.$typeName) { throw new Error("not a WithTwoGenerics json object") };

 return VotingPowerInfo.fromJSONField( json, ) }

 static fromSuiParsedData( content: SuiParsedData ): VotingPowerInfo { if (content.dataType !== "moveObject") { throw new Error("not an object"); } if (!isVotingPowerInfo(content.type)) { throw new Error(`object at ${(content.fields as any).id} is not a VotingPowerInfo object`); } return VotingPowerInfo.fromFieldsWithTypes( content ); }

 static fromSuiObjectData( data: SuiObjectData ): VotingPowerInfo { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isVotingPowerInfo(data.bcs.type)) { throw new Error(`object at is not a VotingPowerInfo object`); }

 return VotingPowerInfo.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return VotingPowerInfo.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }

 static async fetch( client: SuiClient, id: string ): Promise<VotingPowerInfo> { const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching VotingPowerInfo object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isVotingPowerInfo(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a VotingPowerInfo object`); }
...
export class VotingPowerInfoV2 implements StructClass { __StructClass = true as const;
 ...
 static phantom( ): PhantomReified<ToTypeStr<VotingPowerInfoV2>> { return phantom(VotingPowerInfoV2.reified( )); } static get p() { return VotingPowerInfoV2.phantom() }

 static get bcs() { return bcs.struct("VotingPowerInfoV2", {

 validator_index: bcs.u64(), voting_power: bcs.u64(), stake: bcs.u64()

}) };

 static fromFields( fields: Record<string, any> ): VotingPowerInfoV2 { return VotingPowerInfoV2.reified( ).new( { validatorIndex: decodeFromFields("u64", fields.validator_index), votingPower: decodeFromFields("u64", fields.voting_power), stake: decodeFromFields("u64", fields.stake) } ) }
 ...
 return VotingPowerInfoV2.reified( ).new( { validatorIndex: decodeFromFieldsWithTypes("u64", item.fields.validator_index), votingPower: decodeFromFieldsWithTypes("u64", item.fields.voting_power), stake: decodeFromFieldsWithTypes("u64", item.fields.stake) } ) }

 static fromBcs( data: Uint8Array ): VotingPowerInfoV2 { return VotingPowerInfoV2.fromFields( VotingPowerInfoV2.bcs.parse(data) ) }
 ...
 static fromJSONField( field: any ): VotingPowerInfoV2 { return VotingPowerInfoV2.reified( ).new( { validatorIndex: decodeFromJSONField("u64", field.validatorIndex), votingPower: decodeFromJSONField("u64", field.votingPower), stake: decodeFromJSONField("u64", field.stake) } ) }

 static fromJSON( json: Record<string, any> ): VotingPowerInfoV2 { if (json.$typeName !== VotingPowerInfoV2.$typeName) { throw new Error("not a WithTwoGenerics json object") };

 return VotingPowerInfoV2.fromJSONField( json, ) }

 static fromSuiParsedData( content: SuiParsedData ): VotingPowerInfoV2 { if (content.dataType !== "moveObject") { throw new Error("not an object"); } if (!isVotingPowerInfoV2(content.type)) { throw new Error(`object at ${(content.fields as any).id} is not a VotingPowerInfoV2 object`); } return VotingPowerInfoV2.fromFieldsWithTypes( content ); }

 static fromSuiObjectData( data: SuiObjectData ): VotingPowerInfoV2 { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isVotingPowerInfoV2(data.bcs.type)) { throw new Error(`object at is not a VotingPowerInfoV2 object`); }

 return VotingPowerInfoV2.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return VotingPowerInfoV2.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }

 static async fetch( client: SuiClient, id: string ): Promise<VotingPowerInfoV2> { const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching VotingPowerInfoV2 object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isVotingPowerInfoV2(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a VotingPowerInfoV2 object`); }
