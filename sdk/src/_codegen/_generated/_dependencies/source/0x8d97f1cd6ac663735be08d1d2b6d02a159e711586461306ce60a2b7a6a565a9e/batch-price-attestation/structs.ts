...
export function isBatchPriceAttestation(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V1}::batch_price_attestation::BatchPriceAttestation`; }
...
export class BatchPriceAttestation implements StructClass { __StructClass = true as const;

 static readonly $typeName = `${PKG_V1}::batch_price_attestation::BatchPriceAttestation`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = BatchPriceAttestation.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::batch_price_attestation::BatchPriceAttestation`; readonly $typeArgs: []; readonly $isPhantom = BatchPriceAttestation.$isPhantom;
 ...
 private constructor(typeArgs: [], fields: BatchPriceAttestationFields, ) { this.$fullTypeName = composeSuiType( BatchPriceAttestation.$typeName, ...typeArgs ) as `${typeof PKG_V1}::batch_price_attestation::BatchPriceAttestation`; this.$typeArgs = typeArgs;
 ...
 static reified( ): BatchPriceAttestationReified { return { typeName: BatchPriceAttestation.$typeName, fullTypeName: composeSuiType( BatchPriceAttestation.$typeName, ...[] ) as `${typeof PKG_V1}::batch_price_attestation::BatchPriceAttestation`, typeArgs: [ ] as [], isPhantom: BatchPriceAttestation.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => BatchPriceAttestation.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => BatchPriceAttestation.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => BatchPriceAttestation.fromBcs( data, ), bcs: BatchPriceAttestation.bcs, fromJSONField: (field: any) => BatchPriceAttestation.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => BatchPriceAttestation.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => BatchPriceAttestation.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => BatchPriceAttestation.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => BatchPriceAttestation.fetch( client, id, ), new: ( fields: BatchPriceAttestationFields, ) => { return new BatchPriceAttestation( [], fields ) }, kind: "StructClassReified", } }
 ...
 header: this.header.toJSONField(),attestationSize: this.attestationSize.toString(),attestationCount: this.attestationCount.toString(),priceInfos: fieldToJSON<Vector<PriceInfo>>(`vector<${PriceInfo.$typeName}>`, this.priceInfos),
 ...
 static fromSuiObjectData( data: SuiObjectData ): BatchPriceAttestation { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isBatchPriceAttestation(data.bcs.type)) { throw new Error(`object at is not a BatchPriceAttestation object`); }

 return BatchPriceAttestation.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return BatchPriceAttestation.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }
...
export function isHeader(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V1}::batch_price_attestation::Header`; }
...
export class Header implements StructClass { __StructClass = true as const;

 static readonly $typeName = `${PKG_V1}::batch_price_attestation::Header`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = Header.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::batch_price_attestation::Header`; readonly $typeArgs: []; readonly $isPhantom = Header.$isPhantom;
 ...
 private constructor(typeArgs: [], fields: HeaderFields, ) { this.$fullTypeName = composeSuiType( Header.$typeName, ...typeArgs ) as `${typeof PKG_V1}::batch_price_attestation::Header`; this.$typeArgs = typeArgs;
 ...
 static reified( ): HeaderReified { return { typeName: Header.$typeName, fullTypeName: composeSuiType( Header.$typeName, ...[] ) as `${typeof PKG_V1}::batch_price_attestation::Header`, typeArgs: [ ] as [], isPhantom: Header.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => Header.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => Header.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => Header.fromBcs( data, ), bcs: Header.bcs, fromJSONField: (field: any) => Header.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => Header.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => Header.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => Header.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => Header.fetch( client, id, ), new: ( fields: HeaderFields, ) => { return new Header( [], fields ) }, kind: "StructClassReified", } }
 ...
 static fromSuiObjectData( data: SuiObjectData ): Header { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isHeader(data.bcs.type)) { throw new Error(`object at is not a Header object`); }

 return Header.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return Header.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }
