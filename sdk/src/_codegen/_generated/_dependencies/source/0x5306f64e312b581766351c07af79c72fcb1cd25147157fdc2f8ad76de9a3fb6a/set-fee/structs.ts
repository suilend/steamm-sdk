...
export function isGovernanceWitness(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V1}::set_fee::GovernanceWitness`; }
...
export class GovernanceWitness implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `${PKG_V1}::set_fee::GovernanceWitness`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = GovernanceWitness.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::set_fee::GovernanceWitness`; readonly $typeArgs: []; readonly $isPhantom = GovernanceWitness.$isPhantom;

 readonly dummyField: ToField<"bool">

 private constructor(typeArgs: [], fields: GovernanceWitnessFields, ) { this.$fullTypeName = composeSuiType( GovernanceWitness.$typeName, ...typeArgs ) as `${typeof PKG_V1}::set_fee::GovernanceWitness`; this.$typeArgs = typeArgs;

 this.dummyField = fields.dummyField; }

 static reified( ): GovernanceWitnessReified { return { typeName: GovernanceWitness.$typeName, fullTypeName: composeSuiType( GovernanceWitness.$typeName, ...[] ) as `${typeof PKG_V1}::set_fee::GovernanceWitness`, typeArgs: [ ] as [], isPhantom: GovernanceWitness.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => GovernanceWitness.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => GovernanceWitness.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => GovernanceWitness.fromBcs( data, ), bcs: GovernanceWitness.bcs, fromJSONField: (field: any) => GovernanceWitness.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => GovernanceWitness.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => GovernanceWitness.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => GovernanceWitness.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => GovernanceWitness.fetch( client, id, ), new: ( fields: GovernanceWitnessFields, ) => { return new GovernanceWitness( [], fields ) }, kind: "StructClassReified", } }
...
export function isSetFee(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V1}::set_fee::SetFee`; }

export interface SetFeeFields { amount: ToField<"u64"> }

export type SetFeeReified = Reified< SetFee, SetFeeFields >;

export class SetFee implements StructClass { __StructClass = true as const;

 static readonly $typeName = `${PKG_V1}::set_fee::SetFee`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = SetFee.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::set_fee::SetFee`; readonly $typeArgs: []; readonly $isPhantom = SetFee.$isPhantom;

 readonly amount: ToField<"u64">

 private constructor(typeArgs: [], fields: SetFeeFields, ) { this.$fullTypeName = composeSuiType( SetFee.$typeName, ...typeArgs ) as `${typeof PKG_V1}::set_fee::SetFee`; this.$typeArgs = typeArgs;

 this.amount = fields.amount; }

 static reified( ): SetFeeReified { return { typeName: SetFee.$typeName, fullTypeName: composeSuiType( SetFee.$typeName, ...[] ) as `${typeof PKG_V1}::set_fee::SetFee`, typeArgs: [ ] as [], isPhantom: SetFee.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => SetFee.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => SetFee.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => SetFee.fromBcs( data, ), bcs: SetFee.bcs, fromJSONField: (field: any) => SetFee.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => SetFee.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => SetFee.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => SetFee.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => SetFee.fetch( client, id, ), new: ( fields: SetFeeFields, ) => { return new SetFee( [], fields ) }, kind: "StructClassReified", } }
 ...
 static fromSuiObjectData( data: SuiObjectData ): SetFee { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isSetFee(data.bcs.type)) { throw new Error(`object at is not a SetFee object`); }

 return SetFee.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return SetFee.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }
