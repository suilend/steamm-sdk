...
export class DecreeReceipt<T extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;
 ...
 readonly $typeName = DecreeReceipt.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::governance_message::DecreeReceipt<${PhantomToTypeStr<T>}>`; readonly $typeArgs: [PhantomToTypeStr<T>]; readonly $isPhantom = DecreeReceipt.$isPhantom;

 readonly payload: ToField<Vector<"u8">>; readonly digest: ToField<Bytes32>; readonly sequence: ToField<"u64">

 private constructor(typeArgs: [PhantomToTypeStr<T>], fields: DecreeReceiptFields<T>, ) { this.$fullTypeName = composeSuiType( DecreeReceipt.$typeName, ...typeArgs ) as `${typeof PKG_V1}::governance_message::DecreeReceipt<${PhantomToTypeStr<T>}>`; this.$typeArgs = typeArgs;

 this.payload = fields.payload;; this.digest = fields.digest;; this.sequence = fields.sequence; }

 static reified<T extends PhantomReified<PhantomTypeArgument>>( T: T ): DecreeReceiptReified<ToPhantomTypeArgument<T>> { return { typeName: DecreeReceipt.$typeName, fullTypeName: composeSuiType( DecreeReceipt.$typeName, ...[extractType(T)] ) as `${typeof PKG_V1}::governance_message::DecreeReceipt<${PhantomToTypeStr<ToPhantomTypeArgument<T>>}>`, typeArgs: [ extractType(T) ] as [PhantomToTypeStr<ToPhantomTypeArgument<T>>], isPhantom: DecreeReceipt.$isPhantom, reifiedTypeArgs: [T], fromFields: (fields: Record<string, any>) => DecreeReceipt.fromFields( T, fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => DecreeReceipt.fromFieldsWithTypes( T, item, ), fromBcs: (data: Uint8Array) => DecreeReceipt.fromBcs( T, data, ), bcs: DecreeReceipt.bcs, fromJSONField: (field: any) => DecreeReceipt.fromJSONField( T, field, ), fromJSON: (json: Record<string, any>) => DecreeReceipt.fromJSON( T, json, ), fromSuiParsedData: (content: SuiParsedData) => DecreeReceipt.fromSuiParsedData( T, content, ), fromSuiObjectData: (content: SuiObjectData) => DecreeReceipt.fromSuiObjectData( T, content, ), fetch: async (client: SuiClient, id: string) => DecreeReceipt.fetch( client, T, id, ), new: ( fields: DecreeReceiptFields<ToPhantomTypeArgument<T>>, ) => { return new DecreeReceipt( [extractType(T)], fields ) }, kind: "StructClassReified", } }
 ...
 static fromSuiObjectData<T extends PhantomReified<PhantomTypeArgument>>( typeArg: T, data: SuiObjectData ): DecreeReceipt<ToPhantomTypeArgument<T>> { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isDecreeReceipt(data.bcs.type)) { throw new Error(`object at is not a DecreeReceipt object`); }
...
export class DecreeTicket<T extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;
 ...
 readonly $typeName = DecreeTicket.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::governance_message::DecreeTicket<${PhantomToTypeStr<T>}>`; readonly $typeArgs: [PhantomToTypeStr<T>]; readonly $isPhantom = DecreeTicket.$isPhantom;
 ...
 private constructor(typeArgs: [PhantomToTypeStr<T>], fields: DecreeTicketFields<T>, ) { this.$fullTypeName = composeSuiType( DecreeTicket.$typeName, ...typeArgs ) as `${typeof PKG_V1}::governance_message::DecreeTicket<${PhantomToTypeStr<T>}>`; this.$typeArgs = typeArgs;
 ...
 static reified<T extends PhantomReified<PhantomTypeArgument>>( T: T ): DecreeTicketReified<ToPhantomTypeArgument<T>> { return { typeName: DecreeTicket.$typeName, fullTypeName: composeSuiType( DecreeTicket.$typeName, ...[extractType(T)] ) as `${typeof PKG_V1}::governance_message::DecreeTicket<${PhantomToTypeStr<ToPhantomTypeArgument<T>>}>`, typeArgs: [ extractType(T) ] as [PhantomToTypeStr<ToPhantomTypeArgument<T>>], isPhantom: DecreeTicket.$isPhantom, reifiedTypeArgs: [T], fromFields: (fields: Record<string, any>) => DecreeTicket.fromFields( T, fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => DecreeTicket.fromFieldsWithTypes( T, item, ), fromBcs: (data: Uint8Array) => DecreeTicket.fromBcs( T, data, ), bcs: DecreeTicket.bcs, fromJSONField: (field: any) => DecreeTicket.fromJSONField( T, field, ), fromJSON: (json: Record<string, any>) => DecreeTicket.fromJSON( T, json, ), fromSuiParsedData: (content: SuiParsedData) => DecreeTicket.fromSuiParsedData( T, content, ), fromSuiObjectData: (content: SuiObjectData) => DecreeTicket.fromSuiObjectData( T, content, ), fetch: async (client: SuiClient, id: string) => DecreeTicket.fetch( client, T, id, ), new: ( fields: DecreeTicketFields<ToPhantomTypeArgument<T>>, ) => { return new DecreeTicket( [extractType(T)], fields ) }, kind: "StructClassReified", } }
 ...
 static fromSuiObjectData<T extends PhantomReified<PhantomTypeArgument>>( typeArg: T, data: SuiObjectData ): DecreeTicket<ToPhantomTypeArgument<T>> { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isDecreeTicket(data.bcs.type)) { throw new Error(`object at is not a DecreeTicket object`); }
