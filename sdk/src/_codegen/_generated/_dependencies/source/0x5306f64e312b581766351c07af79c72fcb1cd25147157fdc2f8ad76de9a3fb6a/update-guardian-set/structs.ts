...
export function isGovernanceWitness(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V1}::update_guardian_set::GovernanceWitness`; }
...
export class GovernanceWitness implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `${PKG_V1}::update_guardian_set::GovernanceWitness`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = GovernanceWitness.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::update_guardian_set::GovernanceWitness`; readonly $typeArgs: []; readonly $isPhantom = GovernanceWitness.$isPhantom;

 readonly dummyField: ToField<"bool">

 private constructor(typeArgs: [], fields: GovernanceWitnessFields, ) { this.$fullTypeName = composeSuiType( GovernanceWitness.$typeName, ...typeArgs ) as `${typeof PKG_V1}::update_guardian_set::GovernanceWitness`; this.$typeArgs = typeArgs;

 this.dummyField = fields.dummyField; }

 static reified( ): GovernanceWitnessReified { return { typeName: GovernanceWitness.$typeName, fullTypeName: composeSuiType( GovernanceWitness.$typeName, ...[] ) as `${typeof PKG_V1}::update_guardian_set::GovernanceWitness`, typeArgs: [ ] as [], isPhantom: GovernanceWitness.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => GovernanceWitness.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => GovernanceWitness.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => GovernanceWitness.fromBcs( data, ), bcs: GovernanceWitness.bcs, fromJSONField: (field: any) => GovernanceWitness.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => GovernanceWitness.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => GovernanceWitness.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => GovernanceWitness.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => GovernanceWitness.fetch( client, id, ), new: ( fields: GovernanceWitnessFields, ) => { return new GovernanceWitness( [], fields ) }, kind: "StructClassReified", } }
...
export function isGuardianSetAdded(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V1}::update_guardian_set::GuardianSetAdded`; }
...
export class GuardianSetAdded implements StructClass { __StructClass = true as const;

 static readonly $typeName = `${PKG_V1}::update_guardian_set::GuardianSetAdded`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = GuardianSetAdded.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::update_guardian_set::GuardianSetAdded`; readonly $typeArgs: []; readonly $isPhantom = GuardianSetAdded.$isPhantom;

 readonly newIndex: ToField<"u32">

 private constructor(typeArgs: [], fields: GuardianSetAddedFields, ) { this.$fullTypeName = composeSuiType( GuardianSetAdded.$typeName, ...typeArgs ) as `${typeof PKG_V1}::update_guardian_set::GuardianSetAdded`; this.$typeArgs = typeArgs;

 this.newIndex = fields.newIndex; }

 static reified( ): GuardianSetAddedReified { return { typeName: GuardianSetAdded.$typeName, fullTypeName: composeSuiType( GuardianSetAdded.$typeName, ...[] ) as `${typeof PKG_V1}::update_guardian_set::GuardianSetAdded`, typeArgs: [ ] as [], isPhantom: GuardianSetAdded.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => GuardianSetAdded.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => GuardianSetAdded.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => GuardianSetAdded.fromBcs( data, ), bcs: GuardianSetAdded.bcs, fromJSONField: (field: any) => GuardianSetAdded.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => GuardianSetAdded.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => GuardianSetAdded.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => GuardianSetAdded.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => GuardianSetAdded.fetch( client, id, ), new: ( fields: GuardianSetAddedFields, ) => { return new GuardianSetAdded( [], fields ) }, kind: "StructClassReified", } }
 ...
 static fromSuiObjectData( data: SuiObjectData ): GuardianSetAdded { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isGuardianSetAdded(data.bcs.type)) { throw new Error(`object at is not a GuardianSetAdded object`); }

 return GuardianSetAdded.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return GuardianSetAdded.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }
...
export function isUpdateGuardianSet(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V1}::update_guardian_set::UpdateGuardianSet`; }
...
export class UpdateGuardianSet implements StructClass { __StructClass = true as const;

 static readonly $typeName = `${PKG_V1}::update_guardian_set::UpdateGuardianSet`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = UpdateGuardianSet.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::update_guardian_set::UpdateGuardianSet`; readonly $typeArgs: []; readonly $isPhantom = UpdateGuardianSet.$isPhantom;

 readonly newIndex: ToField<"u32">; readonly guardians: ToField<Vector<Guardian>>

 private constructor(typeArgs: [], fields: UpdateGuardianSetFields, ) { this.$fullTypeName = composeSuiType( UpdateGuardianSet.$typeName, ...typeArgs ) as `${typeof PKG_V1}::update_guardian_set::UpdateGuardianSet`; this.$typeArgs = typeArgs;

 this.newIndex = fields.newIndex;; this.guardians = fields.guardians; }

 static reified( ): UpdateGuardianSetReified { return { typeName: UpdateGuardianSet.$typeName, fullTypeName: composeSuiType( UpdateGuardianSet.$typeName, ...[] ) as `${typeof PKG_V1}::update_guardian_set::UpdateGuardianSet`, typeArgs: [ ] as [], isPhantom: UpdateGuardianSet.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => UpdateGuardianSet.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => UpdateGuardianSet.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => UpdateGuardianSet.fromBcs( data, ), bcs: UpdateGuardianSet.bcs, fromJSONField: (field: any) => UpdateGuardianSet.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => UpdateGuardianSet.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => UpdateGuardianSet.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => UpdateGuardianSet.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => UpdateGuardianSet.fetch( client, id, ), new: ( fields: UpdateGuardianSetFields, ) => { return new UpdateGuardianSet( [], fields ) }, kind: "StructClassReified", } }
 ...
 newIndex: this.newIndex,guardians: fieldToJSON<Vector<Guardian>>(`vector<${Guardian.$typeName}>`, this.guardians),
 ...
 static fromSuiObjectData( data: SuiObjectData ): UpdateGuardianSet { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isUpdateGuardianSet(data.bcs.type)) { throw new Error(`object at is not a UpdateGuardianSet object`); }

 return UpdateGuardianSet.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return UpdateGuardianSet.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }
