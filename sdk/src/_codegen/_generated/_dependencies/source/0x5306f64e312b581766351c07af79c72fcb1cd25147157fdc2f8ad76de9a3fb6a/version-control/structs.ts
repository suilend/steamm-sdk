...
export function isV__0_2_0(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V1}::version_control::V__0_2_0`; }

export interface V__0_2_0Fields { dummyField: ToField<"bool"> }

export type V__0_2_0Reified = Reified< V__0_2_0, V__0_2_0Fields >;

export class V__0_2_0 implements StructClass { __StructClass = true as const;

 static readonly $typeName = `${PKG_V1}::version_control::V__0_2_0`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = V__0_2_0.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::version_control::V__0_2_0`; readonly $typeArgs: []; readonly $isPhantom = V__0_2_0.$isPhantom;

 readonly dummyField: ToField<"bool">

 private constructor(typeArgs: [], fields: V__0_2_0Fields, ) { this.$fullTypeName = composeSuiType( V__0_2_0.$typeName, ...typeArgs ) as `${typeof PKG_V1}::version_control::V__0_2_0`; this.$typeArgs = typeArgs;

 this.dummyField = fields.dummyField; }

 static reified( ): V__0_2_0Reified { return { typeName: V__0_2_0.$typeName, fullTypeName: composeSuiType( V__0_2_0.$typeName, ...[] ) as `${typeof PKG_V1}::version_control::V__0_2_0`, typeArgs: [ ] as [], isPhantom: V__0_2_0.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => V__0_2_0.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => V__0_2_0.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => V__0_2_0.fromBcs( data, ), bcs: V__0_2_0.bcs, fromJSONField: (field: any) => V__0_2_0.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => V__0_2_0.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => V__0_2_0.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => V__0_2_0.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => V__0_2_0.fetch( client, id, ), new: ( fields: V__0_2_0Fields, ) => { return new V__0_2_0( [], fields ) }, kind: "StructClassReified", } }
 ...
 static fromSuiObjectData( data: SuiObjectData ): V__0_2_0 { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isV__0_2_0(data.bcs.type)) { throw new Error(`object at is not a V__0_2_0 object`); }

 return V__0_2_0.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return V__0_2_0.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }
